...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Conga Digital Commerce 202508.3.0 on Conga Revenue Lifecycle Platform</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/SendForSignaturePayload.html" data-type="entity-link" >SendForSignaturePayload</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/SignProvider.html" data-type="entity-link" >SignProvider</a>
                            </li>
                            <li class="link">
